<div wire:ignore>
        ...
        <div
            ...
            <template x-for="post in posts">
                ...
                <div
                    ...
                    <!-- Clickable Area -->
                    <div class="tarjeta">
                        {{-- <a class="cursor-pointer" :id="post.id_rubro" onclick="openModal(this.id)"> --}}
                        {{-- <a class="cursor-pointer" :id="post.id_rubro" href="{{ route('menu.show',) }}"> --}}
   ...
   <script>
        ...
        // var tarjetas = document.querySelectorAll("cursor-pointer")
