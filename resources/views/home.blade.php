                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Restobar arrebol ofrece una fusión excepcional de cocina de autor y
                            delicias tradicionales, creando platos cautivadores que deleitan todos los paladares.
                            En Restobar Arrebol, nuestro compromiso es brindarte momentos memorables en un ambiente sofisticado y
                            lleno de calidez. Bienvenido a un lugar donde la pasión por la buena comida se encuentra con
                                    ...
                                    <div class="col-lg-auto">
                                        <ul>
                                            ...
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Picadas</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Hamburguesas</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Ensaladas</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Cervezas</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Tragos</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Sin alcohol</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/tab-icon-03.png"
                                                        alt="">Postres</a></a></li>
                                        </ul>
                                    </div>
                        ...
                        <form id="contact" action="" method="post">
                            <div class="row">
                              ...
                              <fieldset>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <select value="time" name="time" id="time">
                                            ...
                                            <option name="prueba" id="prueba">18:00</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <select value="zona" name="zona" id="zona">
                                            <option value="time">Zona*</option>
                                            <option name="prueba" id="prueba">Primer piso</option>
                                            <option name="prueba" id="prueba">Segundo piso</option>
                                            <option name="prueba" id="prueba">Exterior</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <fieldset>
                                        <button type="submit" id="form-submit" class="main-button-icon">Confirmar
                                            reserva</button>
                                    </fieldset>
                                </div>
                            </div>
