        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    @else
                        <a class="text-sm font-sans hover:underline underline-offset-1 px-4"
                            href="{{ route('users.index') }}">Iniciar
                            Sesión</a>
                        <a class="text-sm font-sans hover:underline underline-offset-1"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @else
            <div class="py-1 border-t border-gray-200">
                ...
                <x-responsive-nav-link href="{{ route('users.registro') }}" :active="request()->routeIs('users.registro')">
                    Registrarse
                </x-responsive-nav-link>
